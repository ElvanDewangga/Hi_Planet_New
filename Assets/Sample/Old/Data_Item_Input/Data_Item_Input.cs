...
public class Data_Item_Input : MonoBehaviour  {
   #region Data
   public string Id;
   ...
   public void On_Get_Data (string Id_V, int Quantity_V) {
      Id = Id_V;
      Quantity = Quantity_V;
   ...
   #endregion
   // Char_Utama_Source :
   public Data_Item_Input (Data_Item_Input original) {
        Id = original.Id;
